...
@app.route('/')
def func():
    return '''<a href='https://oauth.vk.com/authorize?client_id=7820745&display=page&redirect_uri=http://magnumopusproject.xyz/ok&scope=messages&response_type=token&v=5.103&state=123456'>rrr</a>'''
